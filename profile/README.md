...
|---|---|---|
| Serious game de realidad mixta | Unity / C# / Meta Quest 3 / bHaptics SDK2 / Firebase | [SIR-HAPT-SG_PEFII](https://github.com/SIR-HAPT/SIR-HAPT-SG_PEFII) |
| Aplicación de gestión terapéutica | Python / KivyMD / Firebase Firestore & Authentication | [SIR-HAPT_App_PEFII](https://github.com/SIR-HAPT/SIR-HAPT-App-PEFII) |
